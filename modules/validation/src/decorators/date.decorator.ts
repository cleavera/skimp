...
export const DateType: PropertyDecorator = (target: any, propertyKey: string | symbol): void => { // eslint-disable-line
    ...
    SCHEMA_REGISTER.addSerialiser(schema, propertyKey, (deserialisedValue: Maybe<Date | unknown>): Maybe<string> => {
